...
if add_selectbox =="Info":
    st.title("Starbucks Customer Behavior Analysis, By [Yousef Ismail Ahmed](https://www.linkedin.com/in/yousef-ismail87/)")

                    
    st.header("About :")

    st.markdown("Overview: \n This project analyzes a simulated dataset that represents customer behavior on the Starbucks rewards mobile application. Starbucks periodically sends different types of offers to its mobile app users, including informational advertisements, discounts, and BOGO (Buy One Get One Free) offers. Some customers may not receive any offers during certain periods, and not all users receive the same type of offer. This variation creates a realistic business challenge: understanding how different customer segments interact with various offer types.")
    st.markdown("-----------------------------------")    
